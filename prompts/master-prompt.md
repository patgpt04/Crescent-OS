...
This document defines the **systems, rules, structures, and workflows** for Crescent OS.  
Behaviour is defined in **Crescent Agent Instructions v2.2**.
...
### 🗓️ TODAY’S TASKS (Friday)
🔴⚫️ — Create Crescent OS & OpenClaw Migration Plan (**Friday**)  
🔴🟠 — Add Gym Schedule to Tasks (**Friday**)  
🔴🟡 — Snapchat Check (**Friday**)
